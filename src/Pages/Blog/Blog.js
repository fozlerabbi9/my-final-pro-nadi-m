...
const Blog = () => {
    return (
        <div>
            ...
            <div className="ques1 lg:flex" style={{ justifyContent: "space-evenly" }} data-aos="zoom-out">
                <div class="card w-96 bg-base-100 shadow-xl mt-10 cardForMobile" style={{ width: "38rem" }}>
                ...
                <div class="card w-96 bg-base-100 shadow-xl mt-10 cardForMobile" style={{ width: "38rem" }} data-aos="zoom-out">
                    <div class="card-body" style={{ textAlign: "start" }}>
